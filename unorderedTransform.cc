/*
*   wordTransform.cc but with an unordered_map
*
...
std::unordered_map<std::string, std::string> buildMap(std::ifstream&);
const std::string& transform(const std::string&, std::unordered_map<std::string, std::string>&);
...
const std::string&
transform(const std::string& sample, std::unordered_map<std::string, std::string>& tmap) {
